...
!function(e){"function"==typeof define&&define.amd?define(["jquery"],e):"object"==typeof module&&"object"==typeof module.exports?module.exports=e(require("jquery")):e(jQuery)}(function(f){"use strict";f.keyboard=f.keyboard||{},f.fn.addScramble=function(e){var a={targetKeys:/[a-z\d]/i,byRow:!0,byKeySet:!1,randomizeOnce:!0,randomizeInput:!1,init:null,sameForAll:!1};return this.each(function(){var b,c=f(this).data("keyboard"),t=c.namespace+"Scramble",o=c.options;c&&!c.scramble_options&&(b=c.scramble_options=f.extend({},a,e),c.extensionNamespace.push(t),b.orig_create=o.create,c.scramble_setup=function(e){var t,o,a,n,r,i,u,y,d,s,l=e.find("."+f.keyboard.css.keySet);if(e.length){for(b.byKeySet&&(l=l.eq(0)),t=0;t<l.length;t++)if(o=l.eq(t),i=0,s=[],y=[],u=[],d=[],o.children("button, span, br").each(function(){"BR"===this.tagName?(b.byRow?(s.push(this),y.push(!1),d[i]=s,u[i]=y,s=[],y=[]):(d[i]=this,u[i]=!1),i++):(r=!(1!==(r=f(this).attr("data-value")||"").length||!b.targetKeys.test(r))&&r,b.byRow?(s.push(this),y.push(r)):(d[i]=this,u[i]=r,i++))}),o.find("."+f.keyboard.css.endRow).remove(),b.byRow)for(n=0;n<d.length;n++)for(s=c.shuffle(d[n],u[n]),a=0;a<s.length;a++)o.append(s[a]);else for(s=c.shuffle(d,u),a=0;a<s.length;a++)o.append(s[a]);return e=b.byKeySet?c.realign(e):e}},c.getRandomUInt=function(e){var t,o=window.crypto||window.msCrypto;return void 0!==o?(t=new Uint32Array(1),o.getRandomValues(t),t[0]%e):Math.floor(Math.random()*e)},c.shuffle=function(e,t){for(var o,a,n=e.length;0<n;)a=c.getRandomUInt(n),!1===t[n-1]&&n--,!1!==t[n-1]&&!1!==t[a]&&(o=e[--n],e[n]=e[a],e[a]=o);return e},c.realign=function(e){var o,a,n,t=(r=e.find("."+f.keyboard.css.keySet)).eq(0),r=r.filter(":gt(0)");return t.children().each(function(e,t){a="BR"===t.tagName,n=f(t).attr("data-pos"),r.each(function(e,t){o=a?"br:first":'button[data-pos="'+n+'"]',f(t).find(o).appendTo(t)})}),e},c.setScrambleLayout=function(){var e;/^scrambled/.test(o.layout)||(c.orig_layout=o.layout,e=e||"scrambled"+Math.round(1e4*Math.random()),o.layout=b.sameForAll?e:"scrambled"+Math.round(1e4*Math.random()))},o.create=function(){var e=o.layout;f.keyboard.builtLayouts[e]={mappedKeys:{},acceptedKeys:[],$keyboard:null},c.layout=o.layout=c.orig_layout,c.buildKeyboard(c.layout,!0),c.layout=o.layout=e,f.keyboard.builtLayouts[e]=f.extend(!0,{},f.keyboard.builtLayouts[c.orig_layout]),b.randomizeOnce&&(f.keyboard.builtLayouts[e].$keyboard=c.scramble_setup(f.keyboard.builtLayouts[c.orig_layout].$keyboard.clone())),c.$keyboard=f.keyboard.builtLayouts[e].$keyboard,b.randomizeInput?c.$el.unbind(f.keyboard.events.kbChange+t).bind(f.keyboard.events.kbChange+t,function(e,t){b.targetKeys.test(t.last.key)&&(t.$keyboard.find("."+o.css.buttonHover).removeClass(o.css.buttonHover),t.$keyboard=t.scramble_setup(t.$keyboard),f(document.elementFromPoint(e.clientX,e.clientY)).trigger("mouseenter"))}):b.randomizeOnce||c.$el.unbind(f.keyboard.events.kbBeforeVisible+t).bind(f.keyboard.events.kbBeforeVisible+t,function(e,t){t.$keyboard=t.scramble_setup(t.$keyboard)}),"function"==typeof b.orig_create&&b.orig_create(c)},c.setScrambleLayout(),o.alwaysOpen&&c.$keyboard.length?setTimeout(function(){var e=f.keyboard.builtLayouts;c.$keyboard=c.scramble_setup(c.$keyboard),c.setScrambleLayout(),void 0===e[o.layout]&&(e[o.layout]={mappedKeys:f.extend({},e[c.layout].mappedKeys),acceptedKeys:f.extend([],e[c.layout].acceptedKeys),$keyboard:c.$keyboard.clone()}),"function"==typeof b.init&&b.init(c)},0):"function"==typeof b.init&&b.init(c))})}});